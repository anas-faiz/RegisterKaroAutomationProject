...
export enum JobState {
  ...
  VALIDATING_AADHAAR = 'VALIDATING_AADHAAR',
...
export const VALID_TRANSITIONS: Record<JobState, JobState[]> = {
  ...
  [JobState.REENTERING_PAN]: [JobState.VERIFYING_IDENTITY,JobState.FAILED],
  [JobState.VERIFYING_IDENTITY]: [JobState.GENERATING_OTP,JobState.FAILED],
  [JobState.GENERATING_OTP]: [JobState.VALIDATING_AADHAAR,JobState.FAILED],
  [JobState.VALIDATING_AADHAAR]: [JobState.WAITING_FOR_OTP,JobState.FAILED],
