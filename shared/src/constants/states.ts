...
export enum JobState {
  ...
  OPENING_FORGOT_PASSWORD = 'OPENING_FORGOT_PASSWORD',
  REENTERING_PAN = 'REENTERING_PAN',
  SELECT_RESET_OPTION = 'SELECT_RESET_OPTION',
...
export const VALID_TRANSITIONS: Record<JobState, JobState[]> = {
  ...
  [JobState.ENTERING_PAN]: [JobState.OPENING_FORGOT_PASSWORD, JobState.FAILED],
  [JobState.OPENING_FORGOT_PASSWORD]: [JobState.REENTERING_PAN, JobState.FAILED],
  [JobState.REENTERING_PAN]: [JobState.SELECT_RESET_OPTION, JobState.FAILED],
  [JobState.SELECT_RESET_OPTION]: [JobState.VERIFYING_IDENTITY,JobState.FAILED],
  [JobState.VERIFYING_IDENTITY]: [JobState.GENERATING_OTP,JobState.FAILED],
  [JobState.GENERATING_OTP]: [JobState.WAITING_FOR_OTP,JobState.FAILED],
